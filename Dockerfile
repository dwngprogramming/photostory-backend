...
LABEL description="Photostory API - Preserve Your Memories"
...
COPY --from=build /app/build/libs/*.jar photostory.jar
...
ENTRYPOINT ["java", "--enable-preview", "-jar", "photostory.jar"]
